 ...
 * by {@link com.nineoldandroids.animation.ValueAnimator} to define the values that the animation target will have over the course
...
public abstract class Keyframe implements Cloneable {
	 ...
	 * with no initial value must be used as part of an {@link com.nineoldandroids.animation.ObjectAnimator}).
	 ...
	 * an {@link com.nineoldandroids.animation.ObjectAnimator} first starts; keyframes without values are assigned values at
